...
#define LIB_SMS_DEFAULT_FO_IN_SUBMIT_PDU \
    (                                    \
        ((LIB_SMS_PDU_TYPE_SUBMIT) << 0) | ((LIB_SMS_VPF_TYPE_RELATIVE) << 3) | ((LIB_SMS_SUBMIT_PDU_FO_SRR_BIT_NO_STATUS_REPORT) << 5) | ((LIB_SMS_PDU_FO_UDHI_BIT_NO_UDH) << 6))
...
#define LIB_SMS_IS_SUPPORT_CHARSET(CharSet)                                                                                                                                                                 \
    (                                                                                                                                                                                                       \
        (                                                                                                                                                                                                   \
            (LIB_SMS_CHARSET_GSM == (CharSet)) || (LIB_SMS_CHARSET_HEX == (CharSet)) || (LIB_SMS_CHARSET_UCS2 == (CharSet)) || (LIB_SMS_CHARSET_IRA == (CharSet)) || (LIB_SMS_CHARSET_8859_1 == (CharSet))) \
            ? TRUE                                                                                                                                                                                          \
            : FALSE)
...
#define LIB_SMS_IS_VALID_ASCII_NUMBER_CHAR(Char)                                                                                                                                                                                                                       \
    (                                                                                                                                                                                                                                                                  \
        (                                                                                                                                                                                                                                                              \
            (((Char) >= LIB_SMS_CHAR_0) && ((Char) <= LIB_SMS_CHAR_9)) || (LIB_SMS_CHAR_STAR == (Char)) || (LIB_SMS_CHAR_POUND == (Char)) || (((Char) >= LIB_SMS_CHAR_A) && ((Char) <= LIB_SMS_CHAR_C)) || (((Char) >= LIB_SMS_CHAR_a) && ((Char) <= LIB_SMS_CHAR_c))) \
            ? TRUE                                                                                                                                                                                                                                                     \
            : FALSE)
